...
package com.deskind.mnemocontacts.services;
...
public class GoogleService {
    ...
    public static Credential authorize() throws IOException, Exception {
        // Load client secrets.
        InputStream in = 
            GoogleService.class.getResourceAsStream("/google/client_secret.json");
     ...
     * @throws IOException
     */
    public static People getPeopleService() throws IOException, Exception {
